...
(use-package modus-themes
  ...
  (setq modus-themes-common-palette-overrides
        '((bg-line-number-inactive unspecified)
          ...
          (bg-region "{{palettes.tertiary._30.hex | to_color | lighten: -10.0}}") ; neutral with mix of accent
          (bg-hl-line "{{palettes.primary._30.hex | to_color | lighten: -12.5}}")
  ...
  (setq modus-vivendi-palette-user
        '((matugen-pri "{{colors.primary.default.hex}}")
          ...
          (matugen-pri-intense "{{palettes.primary._50.hex | to_color | lighten: 10.0}}")

          (matugen-sec "{{colors.secondary.default.hex}}")
          (matugen-sec-warmer "{{palettes.secondary._60.hex | to_color  | harmonize: {{ "#c40c0c" | to_color }}}}")
          ...
          (matugen-sec-intense "{{palettes.secondary._50.hex | to_color | lighten: 10.0}}")
          ...
          (matugen-tert-intense "{{palettes.tertiary._50.hex | to_color | lighten: 10.0}}")
  ...
  (setq modus-vivendi-palette-overrides
        '(
          (bg-main "{{colors.background.default.hex}}")           ;background
          (bg-dim "{{colors.primary_container.default.hex | to_color | set_saturation: 15.0 | lighten: -15.0}}")           ;background
          ...
          ;; (bg-mode-line-active "{{colors.primary_container.default.hex | to_color | lighten: -10}}") ;primary-container
          (bg-mode-line-active "{{colors.primary_container.default.hex | to_color | set_saturation: 60.0 |  lighten: -6.0}}") ;primary-container
          ...
          (fg-completion-match-1 magenta-cooler)
          (bg-completion "{{palettes.tertiary._50.hex | to_color | lighten: -20.0}}")

          (string "{{ colors.tertiary.default.hex | to_color | lighten: 2.0| to_color | harmonize: {{ palettes.neutral_variant._60.hex | to_color }}}}")
          ...
          (yellow-warmer "{{colors.yellow_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | harmonize: {{ "#c40c0c" | to_color }}}}")
          (yellow-cooler "{{colors.yellow_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | harmonize: {{ "#0ac4e0" | to_color }} | lighten: 5.0 }}")
          (yellow-faint "{{ colors.yellow_source.default.hex | harmonize: {{ colors.source_color.default.hex }}  | to_color | set_saturation: 35.0 | lighten: 5.0}}")
          (yellow-intense "{{colors.yellow_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | lighten: 5.0}}")

          (green "{{ colors.green_source.default.hex | harmonize: {{ colors.source_color.default.hex }} }}")
          (green-warmer "{{colors.green_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | harmonize: {{ "#c40c0c" | to_color }}}}")
          (green-cooler "{{colors.green_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | harmonize: {{ "#0ac4e0" | to_color }} | lighten: 5.0 }}")
          (green-faint "{{ colors.green_source.default.hex | harmonize: {{ colors.source_color.default.hex }}  | to_color | set_saturation: 35.0 | lighten: 5.0}}")
          (green-intense "{{colors.green_source.default.hex | harmonize: {{ colors.source_color.default.hex }} | to_color | lighten: 5.0}}")


          (rust "{{ colors.rust_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (gold "{{ colors.gold_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (olive "{{ colors.olive_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (slate "{{ colors.slate_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (indigo "{{ colors.indigo_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (pink "{{ colors.pink_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          (maroon "{{ colors.maroon_d_source.default.hex | harmonize: {{ colors.source_color.default.hex }}}}")
          )
        )
  )
...
(defun my-modus-themes-custom-faces (&rest _)
  ...
  (modus-themes-with-colors
    ...
    (custom-set-faces!
      '(lin-cyan :background "{{palettes.secondary._30.hex | to_color | lighten: -10.0}}")

      `(diredfl-dir-name :foreground ,rust)
      `(dired-directory :foreground ,rust)
      `(marginalia-file-priv-dir :foreground ,rust)
      '(diredfl-flag-mark :background "{{colors.secondary_container.default.hex | to_color | lighten: -10.0}}" :foreground "{{colors.on_secondary_container.default.hex | to_color | blend: {{ "#f2b949" | to_color }}, 0.3}}")
      '(diredfl-flag-mark-line :background "{{colors.secondary_container.default.hex | to_color | lighten: -10.0}}" :foreground "{{colors.on_secondary_container.default.hex | to_color | blend: {{ "#f2b949" | to_color }}, 0.3}}")

      `(font-lock-constant-face :weight bold :foreground ,cyan-warmer)
      `(highlight-quoted-symbol :inherit nil :foreground ,rust)
      '(marginalia-key :foreground "{{colors.tertiary.default.hex | to_color | harmonize: {{ "#c40c0c" | to_color }} | lighten: -5.0}}")

      `(corfu-default :background ,bg-main :foreground ,fg-main)
      `(corfu-border :background ,matugen-on-sec-container)
      `(consult-preview-insertion :background "{{palettes.secondary._30.hex | to_color | lighten: -10.0}}")

      '(doom-modeline-evil-insert-state :foreground "{{colors.secondary_fixed.default.hex}}")
      '(doom-modeline-evil-visual-state :foreground "{{colors.tertiary_fixed.default.hex}}")
      ...
      `(lsp-ui-peek-highlight :background ,fg-clay :foreground ,bg-clay :box nil)
      `(lsp-ui-peek-selection :background ,bg-clay :foreground ,fg-clay)
