...
in
{
  ...
  config = {
    falak.home.extraOptions = {
      ...
      home.file = mkAliasDefinitions options.falak.home.file;
      programs = mkAliasDefinitions options.falak.home.programs;
      xdg.enable = true;
      xdg.dataFile = mkAliasDefinitions options.falak.home.dataFile;
      xdg.configFile = mkAliasDefinitions options.falak.home.configFile;
    };
    ...
    home-manager = {
      ...
      users.${default.username} =
        { config, ... }:
        mkMerge [
          (mkAliasDefinitions options.falak.home.extraOptions)
